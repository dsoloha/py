...
from spriteUtilsInit import load_sliced_sprites
...
##explosion_list = load_sliced_sprites(80, 80, '../sprites/explosed-Big-sprite.png')
explosion_list = load_sliced_sprites(75, 74, '../sprites/char1_walkA.png')
